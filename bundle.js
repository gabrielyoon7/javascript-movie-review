...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"onClickLogo\": () => (/* binding */ onClickLogo),\n/* harmony export */   \"onSubmitSearchBox\": () => (/* binding */ onSubmitSearchBox)\n/* harmony export */ });\n/* harmony import */ var _utils_eventListener__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/eventListener */ \"./src/utils/eventListener.ts\");\n/* harmony import */ var _utils_selector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/selector */ \"./src/utils/selector.ts\");\n/* harmony import */ var _domain_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../domain/page */ \"./src/domain/page.ts\");\n\n\n\nconst onSubmitSearchBox = () => {\n    (0,_utils_eventListener__WEBPACK_IMPORTED_MODULE_0__.executeEventListener)((0,_utils_selector__WEBPACK_IMPORTED_MODULE_1__.$)(\".search-box\"), {\n        type: \"submit\",\n        prevent: true\n    }, (event) => {\n        const formData = new FormData(event.target);\n        const keyword = String(formData.get(\"search-bar\"));\n        if (keyword === \"\")\n            return;\n        _domain_page__WEBPACK_IMPORTED_MODULE_2__.page.last_keyword = keyword;\n        (0,_domain_page__WEBPACK_IMPORTED_MODULE_2__.resetMoviesAndPages)();\n        _domain_page__WEBPACK_IMPORTED_MODULE_2__.page.showSearchedMovies(keyword);\n    });\n};\nconst onClickLogo = () => {\n    (0,_utils_eventListener__WEBPACK_IMPORTED_MODULE_0__.executeEventListener)((0,_utils_selector__WEBPACK_IMPORTED_MODULE_1__.$)(\"#logo\"), {\n        type: \"click\",\n        prevent: true\n    }, () => {\n        (0,_domain_page__WEBPACK_IMPORTED_MODULE_2__.resetMoviesAndPages)();\n        _domain_page__WEBPACK_IMPORTED_MODULE_2__.page.last_keyword = \"\";\n        _domain_page__WEBPACK_IMPORTED_MODULE_2__.page.showPopularMovies();\n    });\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/Header/headerHandler.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"fetchMovieInfo\": () => (/* binding */ fetchMovieInfo),\n/* harmony export */   \"handleMovieInfoResponse\": () => (/* binding */ handleMovieInfoResponse)\n/* harmony export */ });\n/* harmony import */ var _components_MovieList_movieListHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/MovieList/movieListHandler */ \"./src/components/MovieList/movieListHandler.ts\");\n/* harmony import */ var _page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./page */ \"./src/domain/page.ts\");\n/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Store */ \"./src/domain/Store.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\nconst fetchMovieInfo = (url) => __awaiter(void 0, void 0, void 0, function* () {\n    try {\n        const response = yield fetch(url).then((data) => data.json());\n        if (_page__WEBPACK_IMPORTED_MODULE_1__.page.page === response.page) {\n            handleMovieInfoResponse(response);\n        }\n        else {\n            throw new Error(response.status_message);\n        }\n    }\n    catch (error) {\n        if (error instanceof Error)\n            return alert(error.message);\n    }\n});\nconst handleMovieInfoResponse = (response) => __awaiter(void 0, void 0, void 0, function* () {\n    const { results, total_pages } = yield response;\n    _page__WEBPACK_IMPORTED_MODULE_1__.page.total_page = total_pages;\n    saveMoviesAndRemoveMoreButton(results);\n});\nconst saveMoviesAndRemoveMoreButton = (results) => {\n    _Store__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getInstance().appendMovies(convertApiResponseToMovieList(results));\n    if (_page__WEBPACK_IMPORTED_MODULE_1__.page.page === _page__WEBPACK_IMPORTED_MODULE_1__.page.total_page)\n        (0,_components_MovieList_movieListHandler__WEBPACK_IMPORTED_MODULE_0__.removeMoreButton)();\n};\nconst convertApiResponseToMovieList = (results) => {\n    return results.map((movie) => {\n        return {\n            poster: movie.poster_path,\n            title: movie.title,\n            ratings: movie.vote_average,\n        };\n    });\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/movieApi.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"page\": () => (/* binding */ page),\n/* harmony export */   \"resetMoviesAndPages\": () => (/* binding */ resetMoviesAndPages)\n/* harmony export */ });\n/* harmony import */ var _movieApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./movieApi */ \"./src/domain/movieApi.ts\");\n/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Store */ \"./src/domain/Store.ts\");\n\n\nconst BASE_URL = 'https://api.themoviedb.org/3';\nconst API_KEY = \"614a8fd553d6889b8e75eeaad14066cc\";\nconst page = {\n    page: 1,\n    total_page: 2,\n    last_keyword: \"\",\n    showPopularMovies() {\n        (0,_movieApi__WEBPACK_IMPORTED_MODULE_0__.fetchMovieInfo)(`${BASE_URL}/movie/popular?api_key=${API_KEY}&language=ko&page=${page.page}`);\n    },\n    showSearchedMovies(keyword) {\n        (0,_movieApi__WEBPACK_IMPORTED_MODULE_0__.fetchMovieInfo)(`${BASE_URL}/search/movie?api_key=${API_KEY}&language=ko&page=${page.page}&query=${keyword}`);\n    },\n};\nconst resetMoviesAndPages = () => {\n    _Store__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getInstance().initMovies();\n    page.page = 1;\n    page.total_page = 2;\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/page.ts?");
